    ...
    return (
        <div className='pb-5 pt-10'>
            <div className='flex justify-end gap-5 items-end p-4'>
                <button onClick={() => setWriteArticle(true)} className='cursor-pointer border border-gray-600 bg-red-400 text-white px-4 py-2  rounded-full max-w-[10rem]'>Write Article</button>
